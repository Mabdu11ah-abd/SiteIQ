...
export async function getAuthoritasAccountInfo() {
  ...
  try {
    const response = await axios.get("https://v3.api.analyticsseo.com/account", {
      headers,
    });
    ...
    console.log(`Credits Used: ${account.current_monthly_usage}`);
    console.log(`Credit Limit: ${account.monthly_account_limit}`);
